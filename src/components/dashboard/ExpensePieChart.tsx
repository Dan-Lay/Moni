...
const CATEGORY_FIXED_COLORS: Record<string, string> = {
  "Ajuda Mae": "hsl(220, 40%, 55%)",
  "Investimentos": "hsl(160, 40%, 42%)",
  "Fixas": "hsl(220, 45%, 20%)",
  "Supermercado": "hsl(40, 40%, 55%)",
  "Alimentacao": "hsl(20, 50%, 50%)",
  "Lazer": "hsl(0, 50%, 55%)",
  "Transporte": "hsl(160, 30%, 50%)",
  "Saude": "hsl(220, 30%, 45%)",
  "Compras": "hsl(220, 20%, 60%)",
  "Outros": "hsl(220, 10%, 65%)",
};

const FALLBACK_COLORS = [
  "hsl(220, 45%, 20%)", "hsl(40, 40%, 55%)", "hsl(160, 40%, 42%)",
  "hsl(220, 30%, 45%)", "hsl(0, 50%, 55%)", "hsl(20, 50%, 50%)",
  "hsl(220, 20%, 60%)", "hsl(220, 10%, 65%)",
];
